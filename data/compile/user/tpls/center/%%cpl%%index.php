		...
		<div class="span10 exambox" id="datacontent">
			<div class="examform">
				<div>
					...
					<div>
						<div class="span3">
							<div class="thumbnail"><img alt="300x200" src="<?php if($this->tpl_var['_user']['photo']){ ?><?php echo $this->tpl_var['_user']['photo']; ?><?php } else { ?>app/exam/styles/image/paper.jpg<?php } ?>" /></div>
						</div>
						<div class="span3">
							<div class="caption">
