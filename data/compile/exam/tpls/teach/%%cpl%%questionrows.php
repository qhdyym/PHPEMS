...
<?php } ?>
			...
			<ul class="nav nav-tabs">
				...
				<li class="dropdown pull-right">
					...
					<ul class="dropdown-menu">
						<li><a href="index.php?<?php echo $this->tpl_var['_app']; ?>-teach-rowsquestions-addquestionrows&page=<?php echo $this->tpl_var['page']; ?><?php echo $this->tpl_var['u']; ?>">单题添加</a></li>
						<li><a href="index.php?<?php echo $this->tpl_var['_app']; ?>-teach-rowsquestions-bataddquestionrows&page=<?php echo $this->tpl_var['page']; ?><?php echo $this->tpl_var['u']; ?>">批量添加</a></li>
					</ul>
				</li>
			</ul>
 ...
 $qid++; ?>
			        <tr>
						...
						<td>
							<div class="btn-group">
	                    		<a class="btn" href="index.php?exam-teach-rowsquestions-rowsdetail&questionid=<?php echo $question['qrid']; ?>&page=<?php echo $this->tpl_var['page']; ?><?php echo $this->tpl_var['u']; ?>" title="修改模型信息"><em class="icon-th-list"></em></a>
								<a class="btn" href="index.php?exam-teach-rowsquestions-modifyquestion&questionid=<?php echo $question['qrid']; ?>&page=<?php echo $this->tpl_var['page']; ?><?php echo $this->tpl_var['u']; ?>" title="修改"><em class="icon-edit"></em></a>
								<a class="btn ajax" href="index.php?exam-teach-rowsquestions-delquestion&questionid=<?php echo $question['qrid']; ?>&page=<?php echo $this->tpl_var['page']; ?><?php echo $this->tpl_var['u']; ?>" title="删除"><em class="icon-remove"></em></a>
	                    	</div>
						</td>
			        </tr>
			        <?php } ?>
