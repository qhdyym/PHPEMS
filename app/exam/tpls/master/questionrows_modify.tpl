...
{x2;endif}
			<ul class="breadcrumb">
				...
				<li><a href="index.php?{x2;$_app}-master-rowsquestions&page={x2;$page}{x2;$u}">综合题管理</a> <span class="divider">/</span></li>
				<li class="active">修改综合题</li>
			</ul>
			<ul class="nav nav-tabs">
				...
				<li class="dropdown pull-right">
					<a href="index.php?{x2;$_app}-master-rowsquestions&page={x2;$page}{x2;$u}">综合题管理</a>
				</li>
			</ul>
